...
const AuthLayout = ({children}) => {
  return (
    <div className='flex'>
        ...
        <div className='hidden md:block w-[40vw] h-screen bg-violet-50 bg-auth-bg-img bg-cover bg-no-repeat bg-center p-8 relative'>
            <div className='w-48 h-48 rounded-[40px] bg-purple-600 absolute -top-7 -left-5'/>
            <div className='w-48 h-56 rounded-[40px] border-20 border-fuchsia-600 absolute top-[30%] -right-10'/>
            <div className='w-48 h-56 rounded-[40px] bg-violet-400 absolute -bottom-7 -left-5'/>
            ...
            <img src={CARD2} alt="card" className='w-64 lg:w-[90%] absolute bottom-10 shadow-lg shadow-blue-400/15'/>
        </div>
    </div>
  )
}
